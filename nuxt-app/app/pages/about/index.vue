<template>
	<div>
		...
		<div v-auto-animate class="p-8 rounded-lg bg-neutral-900 w-96">
			<UButton class="text-xl font-bold" @click="isOpen = !isOpen"> Title </UButton>
			<p v-if="isOpen" class="py-8 text-xl font-bold">Description goes here</p>
		</div>

		<UButton @click="dmHasBall = !dmHasBall"> Pass Ball </UButton>
		<div v-auto-animate>
			<UButton
				v-if="dmHasBall"
			...
			<UButton v-if="!dmHasBall" class="w-64 flex justify-center bg-primary">
